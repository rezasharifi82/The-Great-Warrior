            ...
            case ALLEGRO_EVENT_TIMER:
                ...
                if (key[ALLEGRO_KEY_ESCAPE])
                {
                    ...
                    while (!al_key_down(&ks, ALLEGRO_KEY_SPACE))
                    {
                        ...
                        y = 1;
                        z = 31;
                        al_clear_to_color(al_map_rgb(3, 1, 31));
                        al_draw_bitmap(letter, 150, 150, 0);
                        al_draw_text(font1, al_map_rgb(x, y, z), 200, 200, 0, "Resume");
                        al_draw_text(font1, al_map_rgb(x, y, z), 200, 250, 0, "Main Menu");
                        al_draw_text(font1, al_map_rgb(x, y, z), 200, 300, 0, "Quit");
                        al_get_keyboard_state(&ks);
                        if (al_key_down(&ks, ALLEGRO_KEY_1))
                        {
                            al_draw_text(font1, al_map_rgb(i, j, k), 200, 200, 0, "Resume");
                            vallahala = 1;
                        }
                        else if (al_key_down(&ks, ALLEGRO_KEY_2))
                        {
                            al_draw_text(font1, al_map_rgb(i, j, k), 200, 250, 0, "Main Menu");
                            vallahala = 2;
                        }
                        else if (al_key_down(&ks, ALLEGRO_KEY_3))
                        {
                            al_draw_text(font1, al_map_rgb(i, j, k), 200, 300, 0, "Quit");
                            vallahala = 3;
                        }
                        al_flip_display();
                    } //while
